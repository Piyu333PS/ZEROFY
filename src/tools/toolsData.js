...
export const TOOLS = [
  ...
  { id: 'pdf-to-word',      cat: 'pdf', name: 'PDF → Word',          desc: 'Convert PDF to an editable DOCX file',                     icon: '📝', status: 'ready',  route: '/tools/pdf-to-word' },
  ...
  { id: 'protect-pdf',      cat: 'pdf', name: 'Protect PDF',         desc: 'Lock your PDF with a password',                           icon: '🔐', status: 'ready',  route: '/tools/protect-pdf' },
